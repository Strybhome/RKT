#define PIN_ENA 11 // Вывод управления скоростью вращения левого мотора №1
#define PIN_ENB 9 // Вывод управления скоростью вращения правого мотора №2
#define PIN_IN1 12 // Вывод управления направлением вращения левого мотора №1
#define PIN_IN2 6 // Вывод управления направлением вращения левого мотора №1
#define PIN_IN3 7 // Вывод управления направлением вращения правого мотора №2
#define PIN_IN4 10 // Вывод управления направлением вращения правого мотора №2
